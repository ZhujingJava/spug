...
import {AppSelector, AuthButton, AuthDiv, Breadcrumb, SearchForm} from 'components';
...
// console.log('Tabs length:', store.tabs.length);
// console.log('Tabs content:', store.tabs);
//
    return (
