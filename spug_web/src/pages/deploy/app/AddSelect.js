...
import {BuildOutlined, CloudOutlined, OrderedListOutlined} from '@ant-design/icons';
        ...
        return (
            <Modal
                ...
                <Card
                    ...
                    <div>
                        <div className={styles.cardTitle}>Jenkins发布</div>
                        <div className={styles.cardDesc}>
                            通过 Jenkins 进行应用发布，Spug 负责触发 Jenkins 任务并监控发布状态。
                        </div>
                    </div>
                </Card>
