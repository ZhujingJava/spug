...
import {BuildOutlined, GithubFilled, OrderedListOutlined} from '@ant-design/icons';
        ...
        return (
            <Modal
                ...
                <Card
                    ...
                    <div style={{marginRight: 16}}>
                        <GithubFilled style={{fontSize: 36, color: '#7818ff'}}/>
                    </div>
                    <div>
                        <div className={styles.cardTitle}>Jenkins自动化构建</div>
                        <div className={styles.cardDesc}>
                            配置git仓库和工作名称,其他的全交给jenkins进行构建
                        </div>
                    </div>
                </Card>
            </Modal>
